...
const Hero = () => {
  const text = [
    ...
    "Solo Travel, Made Safer and Fun...",
    "Connect with Like-Minded Travelers...",
    "Plan, Travel, and Explore Together...",
    "Wander the World with WanderMate...",
  ];
            ...
            <div className="w-full px-4">
              ...
              >
                ...
                <p className="mb-6 text-base !leading-relaxed font-extralight text-base-content sm:text-lg md:text-xl">
                  ✈️ Are you a solo traveler looking for a companion to share
                  adventures with?
                </p>
                <ul className="list-none pl-5 space-y-2 text-base-content text-left">
                  <li className="text-base">
                    ✅ <strong>Find Compatible Travel Buddies</strong> - Our
                    smart matching algorithm pairs you with travelers who share
                    your journey preferences.
                  </li>
                  <li className="text-base">
                    ✅ <strong>Seamless Communication</strong> - Chat, video
                    call, and plan your trips with your matched travel partners.
                  </li>
                  <li className="text-base">
                    ✅ <strong>Real-Time Location Sharing</strong> - Stay
                    connected and safe while traveling.
                  </li>
                  <li className="text-base">
                    ✅ <strong>Identity Verification & Reviews</strong> - Ensure
                    trust and security with verified profiles and user ratings.
                  </li>
                  <li className="text-base">
                    ✅ <strong>Collaborative Trip Planning</strong> - Plan
                    itineraries, split costs, and make memories together.
                  </li>
                </ul>
                <p className="mt-4 text-base !leading-relaxed font-extralight text-base-content sm:text-lg md:text-xl">
                  Join <strong>Travel Buddy</strong> and experience the world
                  like never before! 🌍✨
                </p>
