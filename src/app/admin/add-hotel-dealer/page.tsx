...
import NewHotel from "./AddHotelDealer";
  ...
  return (
    <>
      <h1 className="text-4xl font-bold my-6 text-center uppercase text-primary">
        Hey Admin, Add Your Hotel Dealer!
      </h1>
      ...
      <button
        ...
        onClick={() => {
          (
            document.getElementById("addNewHotel") as HTMLDialogElement
          ).showModal();
        }}
      >
        Add New Hotel
...
export default AddHotelDealerPage;
