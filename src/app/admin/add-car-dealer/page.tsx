...
import NewCarDealer from "./AddCarDealer";
import {
  IconMail,
  IconMap,
  IconPhone,
  ...
  return (
    <>
      <h1 className="text-4xl font-bold my-6 text-center uppercase text-primary">
        Hey Admin, Add Your Cars Dealer!
      </h1>
      ...
      <button
        ...
        onClick={() => {
          (
            document.getElementById("addNewCar") as HTMLDialogElement
          ).showModal();
        }}
      >
        Add New Car Dealer
...
export default AddCarDealerPage;
